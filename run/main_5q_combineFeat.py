...
from data_combineFeat import data_factory, Normalizer
...
def main(config):
    ...
    df5.to_csv("results/acc_avg_5q_combineFeat.csv", index=False)
    ...
    df6.to_csv("results/pred_labels_5q_combineFeat.csv", index=False)

    df7 = pd.read_csv("train_pred_labels.csv")
    df7.to_csv("results/train_pred_labels_5q_combineFeat.csv", index=False)
