...
for feature_name in feature_names:
    ...
    df5.to_csv("acc_avg_"+feature_name+".csv", index=False)
    ...
    df6.to_csv("pred_labels_"+feature_name+".csv", index=False)

    df7 = pd.read_csv("train_pred_labels.csv")
    df7.to_csv("train_pred_labels_"+feature_name+".csv", index=False)